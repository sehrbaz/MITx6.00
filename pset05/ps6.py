...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        '''
        al = string.ascii_lowercase * 2
        au = string.ascii_uppercase * 2
        d = {}

        for i in range(26):
            d[string.ascii_lowercase[i]] = al[i + shift]
            d[string.ascii_uppercase[i]] = au[i + shift]
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        #return is_word(self.valid_words, self.message_text) and self.message_text
        #return is_word(self.valid_words, self.apply_shift(24))
        ...
        for shift in range(26):
            ...
            if count > maximum:
                ...
                sshift = shift
        self.message_text = b
        return (sshift, self.apply_shift(sshift))
